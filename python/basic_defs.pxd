...
cdef extern from "hermes_basic/basic.h":
    ...
    cdef cppclass ModuleBasic:
        ...
        void set_material_markers(vector[char *] &mat_markers)
        ...
        void set_dirichlet_markers(vector[char *] &bdy_markers_dirichlet)
        void set_dirichlet_values(vector[double] &bdy_values_dirichlet)
        void set_neumann_markers(vector[char *] &bdy_markers_neumann)
        void set_neumann_values(vector[double] &bdy_values_neumann)
        void set_newton_markers(vector[char *] &bdy_markers_newton)
